# assign_2
workflow: sending emails to seak quote and set a meeting with tax filing CPA companies that do service for C-Corp.
Users: startup founders who want to register a C-Corp (e.g. Delaware C-Corp)
Input: 1. Bugdet; 2. Exact tax filing service; 3. Shareholder info (whether there are foreign shareholders); 4. Which state will the business operate; 5. Business category: whether contains sensible industries (firearms/crypto etc.); 6. 1-Phrase business intro.
